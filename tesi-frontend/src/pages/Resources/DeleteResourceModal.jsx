...
// ==========================================
// Conferma la rimozione della SPECIFICA dalla piattaforma, non la distruzione
// di hardware su SLICES: sono due operazioni con semantica diversa. La modale
// compare solo sulle bozze, dove non esiste nulla di allocato.

export default function DeleteResourceModal({ resource, onClose, onConfirm }) {
  return (
    <div
      ...
      >
        ...
        <div className="px-8 pb-6">
          <p className="text-sm text-gray-600 leading-relaxed">
            ...
            will be removed from this experiment. Nothing is allocated on SLICES-RI,
            so no machine is affected.
          </p>
        </div>
